...
$query=mysqli_query($con,"insert into tblsubadminremark(ComplainNumber,ComplainStatus,notetransport,checking,ComplainRemark,RemarkBy) values('$complaintnumber','$status','$notetransport','$checking','$remark','$sadminid')");
