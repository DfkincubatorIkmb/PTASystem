...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Problem</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Description (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Warranty Related Doc(if any) </label>
<div class="col-sm-6">
