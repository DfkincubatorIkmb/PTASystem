...
<html lang="en">
  <head>
    ...
    <title>E-CARE | User Dashboard</title>
...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Repair not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Repair Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Repair has been closed</p>
                      </div>
