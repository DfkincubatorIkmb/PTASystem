...
<head>
	...
	<title>PTA Technician | Repair In Progress</title>
...
$subid=$_SESSION['suid'];
$st='in process';
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name,icnumber as icnumber 
	from tblcomplaints 
	...
	where tblcomplaints.status='$st' and tblforwardhistory.ForwardTo='$subid'");
