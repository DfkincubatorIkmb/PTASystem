...
<head>
	...
	<title>E-CARE Admin| In process Complaints</title>
...
<?php if($type=='npy'){?>
<h4 align="center" style="color:blue">Not processed Yet Complaints of <?php echo $result['SubAdminName']."-".$result['Department'];?> from <?php echo $new_Date = date("d-m-Y", strtotime($fdate));?> to <?php echo $new_Date = date("d-m-Y", strtotime($tdate));?></h4>
<?php } elseif($type=='in'){?>
<h4 align="center" style="color:blue">In Process Complaints of <?php echo $result['SubAdminName']."-".$result['Department'];?> from <?php echo $new_Date = date("d-m-Y", strtotime($fdate));?> to <?php echo $new_Date = date("d-m-Y", strtotime($tdate));?></h4>	
	<?php } else {?>
		<h4 align="center" style="color:blue">Closed Complaints of <?php echo $result['SubAdminName']."-".$result['Department'];?> from <?php echo $new_Date = date("d-m-Y", strtotime($fdate));?> to <?php echo $new_Date = date("d-m-Y", strtotime($tdate));?></h4>	
	<?php } ?>
<hr />
