...
// Dapatkan Complaint ID dari URL
if (!isset($_GET['cid']) || empty($_GET['cid'])) {
    die("Complaint ID tidak sah.");
}
$cid = intval($_GET['cid']);

// SQL gabung tblcomplaints + users + category
$sql = "SELECT 
            tblcomplaints.*,
...
<title>E-CARE Admin | Repair Details</title>
...
<td><b>Report Number</b></td><td colspan="5"><?php echo htmlentities($row['reportNumber']); ?></td>
<td><b>Reg Date</b></td><td><?php echo htmlentities($row['regDate']); ?></td>
</tr>
<tr>
<td><b>Customer Name</b></td><td colspan="5"><?php echo htmlentities($row['name']); ?></td>
<td><b>IC Number</b></td><td colspan="5"><?php echo htmlentities($row['icnumber']); ?></td>
</tr>
<tr>
<td><b>Category</b></td><td colspan="5"><?php echo htmlentities($row['catname']); ?></td>
...
<tr>
<td><b>Purchase</b></td><td colspan="5"><?php echo htmlentities($row['state']); ?></td>
<td><b>Brand Name</b></td><td><?php echo htmlentities($row['brandname']); ?></td>
<td><b>NO Model</b></td><td><?php echo htmlentities($row['modelNo']); ?></td>
</tr>

<tr>
<td><b>Damage</b></td><td colspan="10"><?php echo htmlentities($row['complaintDetails']); ?></td>
</tr>
...
<td colspan="10" style="color:red;"><?php echo empty($row['status']) ? "Not Process Yet" : htmlentities($row['status']); ?></td>
</tr>
...
<tr>
<td><b>Forward to</b></td><td colspan="5"><?php echo htmlentities($result['SubAdminName']); ?> (<?php echo htmlentities($result['Department']); ?>)</td>
<td><b>Forward Date</b></td><td colspan="5"><?php echo htmlentities($result['ForwadDate']); ?></td>
</tr>
<?php } ?>
</tbody>
</table>
...
<?php
// Admin Remarks – check if table exists
